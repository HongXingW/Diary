...
import com.whx.diary.adapter.ImageAdapter;
import com.whx.diary.utils.MyUtils;
...
public class TestActivity extends BaseSlideActivity implements AbsListView.OnScrollListener{
    ...
    private boolean gridViewIsSlide = false;
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if(scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
            gridViewIsSlide = false;

            adapter.notifyDataSetChanged();
        }else {
            gridViewIsSlide = true;
        }

        adapter.setGridSlide(gridViewIsSlide);
    }
}
